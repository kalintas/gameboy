...
pub fn rlc_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.circular_shift_left(memory_map.get(cpu.registers.hl()), 1));
    16
}
...
pub fn rrc_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.circular_shift_right(memory_map.get(cpu.registers.hl()), 1));
    16
}
...
pub fn rl_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.rotate_left_cy(memory_map.get(cpu.registers.hl()), 1));
    16
}
...
pub fn rr_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.rotate_right_cy(memory_map.get(cpu.registers.hl()), 1));
    16
}
...
pub fn sla_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.shift_left_arithmetic(memory_map.get(cpu.registers.hl())));
    16
}
...
pub fn sra_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.shift_right_arithmetic(memory_map.get(cpu.registers.hl())));
    16
}
...
pub fn swap_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.swap(memory_map.get(cpu.registers.hl())));
    16
}
...
pub fn srl_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.shift_right_logical(memory_map.get(cpu.registers.hl())));
    16
}
...
pub fn res_0_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.reset_bit(memory_map.get(cpu.registers.hl()), 0));
    16
}
...
pub fn res_1_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.reset_bit(memory_map.get(cpu.registers.hl()), 1));
    16
}
...
pub fn res_2_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.reset_bit(memory_map.get(cpu.registers.hl()), 2));
    16
}
...
pub fn res_3_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.reset_bit(memory_map.get(cpu.registers.hl()), 3));
    16
}
...
pub fn res_4_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.reset_bit(memory_map.get(cpu.registers.hl()), 4));
    16
}
...
pub fn res_5_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.reset_bit(memory_map.get(cpu.registers.hl()), 5));
    16
}
...
pub fn res_6_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.reset_bit(memory_map.get(cpu.registers.hl()), 6));
    16
}
...
pub fn res_7_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.reset_bit(memory_map.get(cpu.registers.hl()), 7));
    16
}
...
pub fn set_0_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.set_bit(memory_map.get(cpu.registers.hl()), 0));
    16
}
...
pub fn set_1_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.set_bit(memory_map.get(cpu.registers.hl()), 1));
    16
}
...
pub fn set_2_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.set_bit(memory_map.get(cpu.registers.hl()), 2));
    16
}
...
pub fn set_3_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.set_bit(memory_map.get(cpu.registers.hl()), 3));
    16
}
...
pub fn set_4_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.set_bit(memory_map.get(cpu.registers.hl()), 4));
    16
}
...
pub fn set_5_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.set_bit(memory_map.get(cpu.registers.hl()), 5));
    16
}
...
pub fn set_6_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.set_bit(memory_map.get(cpu.registers.hl()), 6));
    16
}
...
pub fn set_7_hl_addr(cpu: &mut Cpu, memory_map: &mut MemoryMap) -> u8 {
    ...
    memory_map.set(cpu.registers.hl(), cpu.set_bit(memory_map.get(cpu.registers.hl()), 7));
    16
}
